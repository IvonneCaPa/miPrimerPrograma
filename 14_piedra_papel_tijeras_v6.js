...
console.log(nombre_jugador);
    ...
    if (jugada_humano == 1 || jugada_humano == 2 || jugada_humano == 0) {
    ...
    Victorias jugador: ${victorias_humano}
    Empates: ${empates}
    Victorias PC: ${victorias_pc}
    `
    var confirmacion = confirm(`${mensaje_marcador}\nPartida finalizada. Volver a jugar???`)
